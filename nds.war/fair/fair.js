...
FAIR.prototype={
    ...
    _onloadMasterObject:function(e){
        ...
        if(ret.data!="null"){
            ...
            if(this.checkIsArray(ret.data)){
                ...
                if(this.data1.length>0){
                    ...
                    for(var j=0;j<this.data1.length;j++){
                        ...
                        fairstr+="<div class=\"pic_height\"><a target=\"_self\" href=\"/fair/order.jsp?pdtid="+this.data1[j].id+"&fairid="+fairid+"\"><img src=\"/pdt/"+this.data1[j].id+"_1_2.jpg\" width=140px height=180px></a></div>";
                        fairstr+="<div class=\"relative\"><a  target=\"_self\" title=\""+value+"\" href=\"/fair/order.jsp?pdtid="+this.data1[j].id+"&fairid="+fairid+"\">"+this.checkvalue(value)+"</a><br>";
                        fairstr+="<a target=\"_self\" title=\""+name+"\" href=\"/fair/order.jsp?pdtid="+this.data1[j].id+"&fairid="+fairid+"\">["+this.checkvalue(name)+"]</a>";
                        ...
                        fairstr+="<a href=\"/fair/order.jsp?pdtid="+this.data1[j].id+"&fairid="+fairid+"\" class=\"icon_file\" title=\"订货\">&nbsp;</a>";
                ...
                fairstr+="<div class=\"pic_height\"><a target=\"_self\" href=\"/fair/order.jsp?pdtid="+data2.id+"&fairid="+fairid+"\"><img src=\"/pdt/"+data2.id+"_1_2.jpg\"  width=140px height=180px></a></div>";
                fairstr+="<div class=\"relative\"><a  target=\"_blank\" title=\""+value+"\" href=\"/fair/order.jsp?pdtid="+data2.id+"&fairid="+fairid+"\">"+this.checkvalue(value)+"</a><br>";
                fairstr+="<a target=\"_self\" title=\""+name+"\" href=\"/fair/order.jsp?pdtid="+data2.id+"&fairid="+fairid+"\">["+this.checkvalue(name)+"]</a>";
                ...
                fairstr+="<a href=\"/fair/order.jsp?pdtid="+data2.id+"&fairid="+fairid+"\" class=\"icon_file\" title=\"订货\">&nbsp;</a>";
                fairstr+="</div></div></div></div>";
            }
            fairstr+="<div class=\"clear\"></div>";
            ...
            jQuery("#detail_view_inner img").bind("error",function(){
                this.src = "/pdt/nopic.jpg";
            });
        }else{
    ...
    imageopen:function(id){
        ...
        window.open('/fair/image.jsp?pdtid='+id+'&imageindex='+imageindex ,'_blank','height=400,width=350,top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
    },
            ...
            if(this.checkIsArray(ret.data)){
                ...
                if(this.data3.length>0){
                    ...
                    for(var j=0;j<this.data3.length;j++){
                        ...
                        fairstr+="<div class=\"pic_height\"><a target=\"_self\" href=\"/fair/order.jsp?pdtid="+this.data3[j].id+"&fairid="+fairid+"\"><img src=\"/pdt/"+this.data3[j].id+"_1_2.jpg\" width=\"140px\" height=\"180px\"></a></div>";
                        ...
                        fairstr+="<div class=\"icon_revised_delete\"><div class=\"icon_revised\"><a target=\"_self\" href=\"/fair/order.jsp?pdtid="+this.data3[j].id+"&fairid="+fairid+"\"><img src=\"/fair/images/icon_revised.gif\" width=\"31\" height=\"16\"/></a></div><div class=\"icon__delete\"><a target=\"_self\" href=\"javascript:fair.delpdt("+fairid+","+this.data3[j].id+")\"><img src=\"/fair/images/icon_delete.gif\" width=\"31\" height=\"16\" /></a></div></div>";
                        fairstr+="</div>";
                ...
                fairstr+="<div class=\"icon_revised_delete\"><div class=\"icon_revised\"><a target=\"self\" href=\"/fair/order.jsp?pdtid="+data2.id+"&fairid="+fairid+"\"><img src=\"/fair/images/icon_revised.gif\" width=\"31\" height=\"16\"/></a></div><div class=\"icon__delete\"><a target=\"_self\" href=\"javascript:fair.delpdt("+fairid+","+data2.id+")\"><img src=\"/fair/images/icon_delete.gif\" width=\"31\" height=\"16\" /></a></div></div>";
                fairstr+="</div>";
            }
    ...
    search_order:function(){
        var fairid=$("fairid").value;
        window.location="/fair/index.jsp?fairid="+fairid+"&srinfo="+document.getElementById("srinfox").value;
    },
