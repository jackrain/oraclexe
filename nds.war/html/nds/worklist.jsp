<%@ include file="/html/nds/init.jsp" %>
<%
	if(!userWeb.isActive()){
%>
...
<a href="#<%=linkTitle[i]%>"><%=linkTitle[i]%></a> <%=(i==linkTitle.length-1?"":"|")%>
<%}%>  	
</td></tr></table><br>
...
<script>
function opw(tid){
 window.location="<%=NDS_PATH%>/objext/objects.jsp?table="+tid;
}
</script>
<table width=80% align=center border=0 cellpadding=0 cellspacing=0>
<form action="<%=NDS_PATH+"/objext/object_portal.jsp"%>" method="get" name="search_fm">
