...
<%
	/**
	Create filter for column of specified table record. For instance, we have m_distribution table
	and want order_condition and order_filter to contain filter expression for sale order. To create
	that filter screen, following parameters are needed:
	@param tableid - the table that contains the filter columns
	@param objectid - table id of that record
	@param column_desc - column that accept filter description
	@param column_sql - column that accept filter sql clause
	@param table_filter - table on which filter imposes
	*/
