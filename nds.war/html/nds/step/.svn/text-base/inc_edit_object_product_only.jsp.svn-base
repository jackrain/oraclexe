...
%>
	...
	&nbsp;&nbsp;&nbsp;<%=commandFactory.newButtonInstance("DeleteLine", PortletUtils.getMessage(pageContext, "command.deleteline",null),"step.doDeleteLine()", "E").toHTML()%>
	<%}%>
	<input class="cbutton" type="button" value="<%=PortletUtils.getMessage(pageContext, "command.saveline",null)%>(S)" onclick="step.doSaveLine();">
	</td>
<td>
