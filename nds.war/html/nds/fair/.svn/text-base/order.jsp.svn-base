...
%>
<a target="_self" href="/html/nds/fair/index.jsp?fairid=<%=fairid%>">首页</a>&gt;&gt;&nbsp;<a href="/html/nds/fair/index.jsp?categoryid=<%=id%>&fairid=<%=fairid%>"><%=attribname%></a>&gt;&gt;&nbsp;<%=pdtvalue%>
</div>
	  ...
	  <div id="product_list">
		<span class="de_logo">
		    ...
		    <div class="list_inner">
						...
						<p class="public_notic"><a href="javascript:fair.search_order();"><image src="/html/nds/fair/images/search.gif" class="inputMain" border="0" /></a></p>
						</div>
...
%>
<li><a  target="_self" href="/html/nds/fair/index.jsp?categoryid=<%=pci.getCategoryId()%>&fairid=<%=fairid%>" ><%=pci.getName()%> <span class="graytxt">(<%=pci.getCnt()%>款)</span></a></li>
<%
}}
%>
</ul>
