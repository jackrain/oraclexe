...
<img style="display: none; opacity: 0.9999;" src="/html/nds/fair/images/40_1228383443.jpg" usemap="#js_home_banner_map3" width="650" height="192">
<a href="/html/nds/fair/index.jsp" target="_blank"><img style="display: block; opacity: 0.9999;" class="js_home_banner" id="js_home_banner_2" src="images/40_1228383443.jpg" width="650" height="192"></a>
</div>
<div><span>&nbsp;
</span></div>
<div id="product_pageBody">
	  <div id="product_list">
		 <span class="de_logo">
		     <a href="/html/nds/fair/index.jsp?fairid=<%=fairid%>"><img src="images/company_logo.gif" width="179" height="73" /></a>
		</span>
    				<div class="list_inner">
						...
						<p class="public_notic"><a href="javascript:fair.search_index();"><image src="/html/nds/fair/images/search.gif" class="inputMain" border="0" /></a></p>
						</div> 
