                  ...
                  <tr>
                    <td  colspan="2">
                      <table align="center" border="0" cellpadding="1" cellspacing="1" width="90%" >
                        ...
                        %>
                          <td height="18" width="<%=widthPerColumn*2/3%>%" nowrap align="left"><%=desc%>:</td>
                          <td height="18" width="<%=widthPerColumn*4/3%>%" nowrap align="left">
                           ...
                           <%
                                if(column.getReferenceTable() !=null){
                                    // create link
                                    String url=request.getContextPath()+"/servlets/query?table="+column.getReferenceTable().getId()+"&return_type=s&accepter_id="+form_name+"."+column_acc_Id;
                                    %><a href='#' onclick=popup_window("<%=url%>","<%="T"+System.currentTimeMillis() %>")><img border=0 width=16 height=16 align=absmiddle src='../images/find.gif' alt='点击打开新页面查找本项内容'></a>
                                    <%
                                }
