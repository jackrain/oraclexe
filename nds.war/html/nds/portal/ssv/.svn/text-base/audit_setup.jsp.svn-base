...
FKObjectQueryModel fkQueryModel=new FKObjectQueryModel(TableManager.getInstance().getTable("users"), "assignee2",null);
...
<table border="0" cellpadding="4" cellspacing="0" width="100%">
	...
	<tr>
		<td align="center">
			...
			<tr>
				<td><img border="0" height="8" hspace="0" src="/html/nds/images/spacer.gif" vspace="0" width="1"></td>
			</tr>
			<tr>
				<td align="center">
					<%if(assigneeId==-1){%>
					<input class="cbutton" type="button" value="<%=PortletUtils.getMessage(pageContext, "set-out",null)%>" onclick="oa.setupAuditForm('setout')" >&nbsp;&nbsp;
					<%}else{%>
					<input class="cbutton" type="button" value="<%=PortletUtils.getMessage(pageContext, "save",null)%>" onclick="oa.setupAuditForm('setout')" >&nbsp;&nbsp;
					<input class="cbutton" type="button" value="<%=PortletUtils.getMessage(pageContext, "cancel-out",null)%>" onclick="oa.setupAuditForm('cancelout')" >&nbsp;&nbsp;
					<%}%>
				</td>
			</tr>
			</table>
