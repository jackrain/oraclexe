...
<%
// added by yfzhu to check page permissions
	nds.control.web.WebUtils.checkDirectoryWritePermission("WIKI", request);
    ...
    if( ok != null )
    {
        ...
        if( comment != null )
        {
            ...
            pageText.append( request.getParameter("text" ) );
