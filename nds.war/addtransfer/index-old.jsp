...
<!--<table width="228">
  <tr>
        ...
        <td class="text-right"><a onclick="window.location.reload();" href="#"><img src="images/s1-search_20.png" /></a></td>
      ...
      <tr height="30">
       ...
       <td class="text-right" width="100">店仓（多选）<font color="red">*</font>：</td>
        <td class="width-190">
        	...
        	<span  class="coolButton" id="column_26993_link" title=popup onaction="oq.toggle_m('/html/nds/query/search.jsp?table=<%=destStore%>&return_type=f&accepter_id=column_26993', 'column_26993');"><img id='column_26993_img' title="Find" style="vertical-align:bottom; padding-left:6px;" src="/html/nds/images/filterobj.gif"/></span>
      ...
      <tr height="30">
        ...
        <td><input class="input_s02" type="text" name="billdatebeg"  tabIndex="5" maxlength="10" size="20" title="8位日期，如20070823" id="column_26997" value="<%=end%>"/>
         <span id="end_coolButton"  class="coolButton">
                                    <a onclick="event.cancelBubble=true;" href="javascript:showCalendar('imageCalendar23',false,'column_26997',null,null,true);"><img id="imageCalendar23"  title="Find" style="vertical-align:bottom; padding-left:6px;" src="images/s1-search_22.png" /></a>
                                </span>
                                </td>              
      	</tr>
      <tr height="30">
