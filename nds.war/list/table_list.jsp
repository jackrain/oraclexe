...
String dataconf = ParamUtils.getAttributeOrParameter(request, "listdataconf");
String uiconf =  ParamUtils.getAttributeOrParameter(request, "listuiconf");
...
<%@ include file="/list/table_list_result.jsp" %>
<%
