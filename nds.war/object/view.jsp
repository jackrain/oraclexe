...
if (uiConfig!=null){
	...
	if(table!=null){
		if(!("U_NEWS".equals(table.getRealTableName()) || "B_PDT_CATALOG".equals(table.getRealTableName()) || "C_BPARTNER".equals(table.getRealTableName())  ))
			throw new NDSException("No permission for "+ table);
%>
