...
<script language="javascript" src="/groups/cost.js"></script>
<script type="text/javascript" src="/html/nds/js/init_object_query_zh_CN.js"></script>

<link type="text/css" rel="stylesheet" href="/groups/link.css">
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="800" valign="top">
              ...
              <tr>
				...
				<div class="left002">源用户组<font color="red">*</font>:</div>
				<div class="right002">
          ...
          <input type='hidden' name="dealer_query2_filter" id="dealer_query1_filter"/>
					...
					<span id="dealer_query2_link" title="popup" onaction="oq.toggle('/html/nds/query/search.jsp?table=groups&return_type=s&accepter_id=dealer_query2','dealer_query2')">
						<img  id="dealer_query2_img" border=0 width=16 height=16 align=absmiddle src='/html/nds/images/find.gif' alt='<%=PortletUtils.getMessage(pageContext, "open-new-page-to-search",null)%>'></span> 
				</div>
			...
			<div class="right001">
				...
				<div class="left003">目标用户组<font color="red">*</font>:</div>
				<div class="right003">
